...
public class PostoController implements Serializable{
	...
	public void carregarLista() {
		...
		lista = em.createQuery("from Posto").getResultList();
		em.close();
	}

	public void incluir() {
		editando = true;
		selecionado = new Posto();
	}
	...
	public void setLista(List<Posto> lista) {
		this.lista = lista;
	}

	public Posto getSelecionado() {
		return selecionado;
	}

	public void setSelecionado(Posto selecionado) {
